...
Log events have stable IDs: 1 to 3 at start-up, 20 to 25 in the runner, 30 to 33 for jobs. Every start-up error is a `DeedboxException` with a [DBX code](/reference/errors/).
